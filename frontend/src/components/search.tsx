      ...
      <View style = {{flexDirection: 'row', justifyContent: 'space-around'}}>
          <View style = {{flexDirection: 'row', justifyContent: 'space-between', borderWidth: 2, borderRadius: 20, borderColor: '#155A03'}}>
            <View style = {{flexDirection: 'row', alignItems: 'center'}}>
              {/* Search Icon */}
              <Pressable style={{alignItems:'center',justifyContent:'center', margin: 0, padding: 10}} onPress = {()=>{console.log("Pressed")}} underlayColor = 'transparent'>
                  <View>
            ...
            {/* Filter icon */}
            <Pressable style={{alignItems:'center',justifyContent:'center', margin: 0, padding: 0}} onPress = {()=>{console.log("Pressed")}} underlayColor = 'transparent'>
                <View>
        ...
        {/* Basket Icon */}
          <Pressable style={{alignItems:'center', position: 'relative',justifyContent:'center', borderWidth: 2, width: 50, height: 50, borderRadius: 25, borderColor: '#155A03'}} onPress = {()=>{router.replace('/basket')}} underlayColor = 'transparent'>
